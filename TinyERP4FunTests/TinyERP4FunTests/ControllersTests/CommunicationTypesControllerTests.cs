...
{
    public class CommunicationTypesControllerTests
    {
        readonly Mock<ICommunicationTypesService> mock;
        readonly CommunicationTypesController validController;
        readonly CommunicationTypesController notValidController;
        readonly CommunicationType entity;
        readonly Type indexResultType = typeof(EnumerableQuery<CommunicationType>);
        readonly string indexActionName = "Index";

        public CommunicationTypesControllerTests()
        {
            var mockingEntities = new MockingEntities2<CommunicationType, 
                                                       CommunicationTypesController, 
                                                       ICommunicationTypesService>();
