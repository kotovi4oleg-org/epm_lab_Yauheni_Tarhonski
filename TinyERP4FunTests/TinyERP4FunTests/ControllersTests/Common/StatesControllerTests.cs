...
namespace Tests.TinyERP4FunTests.Common
{
    ...
    {
        readonly Mock<IStatesService> mock;
        readonly StatesController validController;
        readonly StatesController notValidController;
        readonly State entity;
        readonly Type indexResultType = typeof(PaginatedList<State>);
