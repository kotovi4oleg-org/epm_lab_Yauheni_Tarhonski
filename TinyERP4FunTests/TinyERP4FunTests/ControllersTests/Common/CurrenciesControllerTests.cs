...
namespace Tests.TinyERP4FunTests.Common
{
    ...
    {
        readonly Mock<ICurrenciesService> mock;
        readonly CurrenciesController validController;
        readonly CurrenciesController notValidController;
        readonly Currency entity;
        readonly Type indexResultType = typeof(PaginatedList<Currency>);
