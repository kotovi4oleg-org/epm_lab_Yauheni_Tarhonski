...
namespace TinyERP4Fun.Tests.Controllers.ExpencesTests
{
    public class DocumentTypesControllerTests
    {
        readonly Mock<IDocumentTypesService> mock;
        readonly DocumentTypesController validController;
        readonly DocumentTypesController notValidController;
        readonly DocumentType entity;
        readonly Type indexResultType = typeof(EnumerableQuery<DocumentType>);
