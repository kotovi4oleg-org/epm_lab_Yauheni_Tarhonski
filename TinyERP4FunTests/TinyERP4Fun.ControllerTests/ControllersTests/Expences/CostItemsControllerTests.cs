...
namespace TinyERP4Fun.Tests.Controllers.ExpencesTests
{
    ...
    {
        readonly Mock<ICostItemsService> mock;
        readonly CostItemsController validController;
        readonly CostItemsController notValidController;
        readonly CostItem entity;
        readonly Type indexResultType = typeof(EnumerableQuery<CostItem>);
