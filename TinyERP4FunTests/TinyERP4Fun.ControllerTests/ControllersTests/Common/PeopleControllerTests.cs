...
namespace TinyERP4Fun.Tests.Controllers.CommonTests
{
    public class PeopleControllerTests
    {
        ...
        readonly PersonViewModel personViewModel;
        ...
        public PeopleControllerTests()
        {
            ...
            personViewModel = new PersonViewModel { Person = entity };
        }
        ...
        public async Task EditPostAction_UpdateModelFromService()
        {
            ...
            // Act
            var result = await validController.Edit(entity.Id, personViewModel);

            // Assert
            mock.Verify(a => a.UpdateAsync(personViewModel.Person, personViewModel.SelectedRoles));
        }
