...
namespace TinyERP4Fun.Tests.Services.ExpensesTests
{
    public class DocumentTypesServiceTests
    {
        ...
        public Mock<DbSet<DocumentType>> MockSet { get; set; }
        public DocumentType singleEntity = new DocumentType { Id = 2 };
        public DocumentType newEntity = new DocumentType { Id = 15 };
        public DocumentType anyEntity = It.IsAny<DocumentType>();
        public DocumentTypesService testedService;
        public readonly IQueryable<DocumentType> testEntities =
            new DocumentType[] {
                        new DocumentType {Id=0},
                        new DocumentType {Id=1},
                        new DocumentType {Id=2},
                        new DocumentType {Id=3},
                        new DocumentType {Id=4}
                        }.AsQueryable();
