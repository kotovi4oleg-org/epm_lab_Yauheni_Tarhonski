...
namespace TinyERP4Fun.Tests.Services.CommonTests
{
    public class PositionsServiceTests
    {
        ...
        public Mock<DbSet<Position>> MockSet { get; set; }
        public Position singleEntity = new Position { Id = 2 };
        public Position newEntity = new Position { Id = 15 };
        public Position anyEntity = It.IsAny<Position>();
        public PositionsService testedService;
        public readonly IQueryable<Position> testEntities =
            new Position[] {
                        new Position {Id=0},
                        new Position {Id=1},
                        new Position {Id=2},
