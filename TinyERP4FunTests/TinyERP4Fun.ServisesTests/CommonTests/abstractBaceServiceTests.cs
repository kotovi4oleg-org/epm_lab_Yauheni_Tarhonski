...
{
    public class AbstractBaseServiceTests
    {
        public class AbstractBaseService : BaseService<Country>, IBaseService<Country>
        {
            public AbstractBaseService(IDefaultContext context) : base(context)
            {
            }
        }

        public Mock<IDefaultContext> Mock { get; set; }
        public AbstractBaseService testedService;
        ...
        [Fact]
        public void GetIQueryable_ReturnsRightsValues()
        {
            //Assert
