...
namespace TinyERP4Fun.Tests.Services.CommonTests
{
    public class DepartmentsServiceTests
    {
        ...
        public Mock<DbSet<Department>> MockSet { get; set; }
        public Department singleEntity = new Department { Id = 2 };
        public Department newEntity = new Department { Id = 15 };
        public Department anyEntity = It.IsAny<Department>();
        public DepartmentsService testedService;
        public readonly IQueryable<Department> testEntities =
            new Department[] {
                        new Department {Id=0},
                        new Department {Id=1},
                        new Department {Id=2},
