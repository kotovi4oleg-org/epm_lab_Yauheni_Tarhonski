...
namespace TinyERP4Fun.Tests.Services.StockTests
{
    public class ItemServiceTests
    {
        ...
        public Item singleEntity = new Item { Id = 2 };
        public Item newEntity = new Item { Id = 15 };
        public Item anyEntity = It.IsAny<Item>();
        public ItemService testedService;
        public readonly IQueryable<Item> testEntities =
            new Item[] {
                        new Item {Id=0},
                        new Item {Id=1},
                        new Item {Id=2},
        ...
        public ItemServiceTests()
        {
            ...
            Mock.Setup(c => c.Set<Item>()).Returns(MockSet.Object);
            Mock.Setup(c => c.Item).Returns(MockSet.Object);
            testedService = new ItemService(Mock.Object);
        }
        [Fact]
