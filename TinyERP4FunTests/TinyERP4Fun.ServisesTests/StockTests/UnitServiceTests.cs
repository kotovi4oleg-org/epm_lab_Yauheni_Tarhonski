...
namespace TinyERP4Fun.Tests.Services.StockTests
{
    public class UnitServiceTests
    {
        ...
        public Mock<DbSet<Unit>> MockSet { get; set; }
        public Unit singleEntity = new Unit { Id = 2 };
        public Unit newEntity = new Unit { Id = 15 };
        public Unit anyEntity = It.IsAny<Unit>();
        public UnitService testedService;
        public readonly IQueryable<Unit> testEntities =
            new Unit[] {
                        new Unit {Id=0},
                        new Unit {Id=1},
                        new Unit {Id=2},
        ...
        public UnitServiceTests()
        {
            ...
            Mock.Setup(c => c.Set<Unit>()).Returns(MockSet.Object);
            Mock.Setup(c => c.Unit).Returns(MockSet.Object);
            testedService = new UnitService(Mock.Object);
        }
        [Fact]
