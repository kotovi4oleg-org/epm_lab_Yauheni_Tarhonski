...
{
    public partial class _300519NewBase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusinessDirection", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Part001Name = table.Column<string>(nullable: true),
                    Part001Name2 = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Name = table.Column<string>(nullable: true),
                    BusinessDirectionId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CostItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CostItem_BusinessDirection_BusinessDirectionId",
                        column: x => x.BusinessDirectionId,
                        principalTable: "BusinessDirection",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CurrecyScale = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurrencyRates_Currency_BaseCurrencyId",
                        column: x => x.BaseCurrencyId,
                        principalTable: "Currency",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CurrencyRates_Currency_CurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TIN2 = table.Column<string>(nullable: true),
                    CityId = table.Column<long>(nullable: true),
                    Address = table.Column<string>(nullable: true),
                    Address2 = table.Column<string>(nullable: true),
                    HeadCompanyId = table.Column<long>(nullable: true),
                    OurCompany = table.Column<bool>(nullable: false),
                    BaseCurrencyId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsChief = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Communication_CommunicationType_CommunicationTypeId",
                        column: x => x.CommunicationTypeId,
                        principalTable: "CommunicationType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Communication_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonId = table.Column<long>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
                    OurCompanyId = table.Column<long>(nullable: true),
                    CompanyId = table.Column<long>(nullable: true),
                    DesiredPaymentDate = table.Column<DateTime>(nullable: false),
                    TransferOfPayment = table.Column<DateTime>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Expences_Company_OurCompanyId",
                        column: x => x.OurCompanyId,
                        principalTable: "Company",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Expences_Person_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Person",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Expences_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Communication_CompanyId",
                table: "Communication",
                column: "CompanyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CostItem_BusinessDirectionId",
                table: "CostItem",
                column: "BusinessDirectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expences_CompanyId",
                table: "Expences",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Expences_CurrencyId",
                table: "Expences",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Expences_DocumentTypeId",
                table: "Expences",
                column: "DocumentTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Expences_OurCompanyId",
                table: "Expences",
                column: "OurCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Expences_PersonId",
                table: "Expences",
                column: "PersonId");
